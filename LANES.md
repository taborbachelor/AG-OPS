...
2. **Terrain following.** Half done as of 2026-08-19. **The data half has landed** (TASK-008):
   ...
   **Still open: `TERRAIN_REQUEST`/`TERRAIN_DATA` in the GCS** (TASK-010, which also carries seam
   S3), then the SITL proof (TASK-011). Not optional at 10–25 m AGL.
